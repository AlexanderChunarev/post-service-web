...
function ResponsiveDrawer(props) {
    ...
    const drawer = (
        <div>
            <div className={classes.toolbar}><h1>Нова Українська Пошта</h1></div>
            <Divider/>
            <List>

                <ListItem button key='Створити замовлення'>
                    <ListItemIcon><AddIcon/></ListItemIcon>
                    <Link to={`/user-cabinet/create-order`}><ListItemText primary='Створити замовлення' /></Link>
                </ListItem>
